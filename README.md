...
git clone https://github.com/yijionglin/tactile_sim_2
cd tactile_sim
...
We use [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) for all training, helper scripts are provided in `tactile_sim/sb3_helpers/`
...
and placed in `tactile_sim/sb3_helpers/saved_models`.

```
python tactile_sim/sb3_helpers/eval_agent_utils.py
```
...
and placed in `tactile_sim/examples/enjoy`.
